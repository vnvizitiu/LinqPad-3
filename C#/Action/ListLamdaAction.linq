...
void Main()
{
    var films = new List<Film>
    {
        ...
        new Film {Name="The Usual Suspects", Year=1995},
		 new Film {Name="Awesome Beauty", Year=1999}
    };
	...
	Action<int> example=(int x)=>Console.WriteLine(x);
	example.Invoke(films.Count());
	
	example.Invoke(films.Count(f => f.Name.StartsWith("A")));
