...
void Main() //assignee = currentUser() OR component = PAPA  and sprint in("All")
{
	...
	String[] foos = new String[] {"project = BIDA AND resolution = Unresolved AND status in (Open, Reopened, Resolved, Closed) AND assignee in (membersOf(jira-users)) ORDER BY updatedDate DESC"}; 
...
public class Program
{
	public  void MainPro(string[] args)
	{
		...
		string password = "Hotdog88";// Console.ReadLine();
		...
		string projectStringIndex ="216";// Console.ReadLine(); this could change and throw exception
