...
//	string xjData = @"{""fields"":{""project"":{""key"": ""BIDA""},""summary"": ""Jira raised via REST API-alternative"",
//                               ""description"": ""To test if raising JI?A via REST API is possible"",""issuetype"": {""name"": ""Improvement""}}}";
							   
	string 	jData=@"{""body"":""[~Samtran]""}";						   
	JavaScriptSerializer json_serializer = new JavaScriptSerializer();
	Body jsonIssue = json_serializer.Deserialize<Body>(jData);
	...
	string postUrl = "https://jira.odp.cba/rest/api/2/issue/BIDA-1424/comment";
	...
	System.Net.Http.HttpContent content = new System.Net.Http.ObjectContent<Body>(jsonIssue, jsonFormatter);
