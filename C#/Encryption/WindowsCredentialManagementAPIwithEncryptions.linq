...
{
string[] foos = new string[] { "JiraPassword", "MyKeys" };
string encryptedpwd= StringCipher.Encrypt("JiraPasword", "MyKeys");
//Console.WriteLine(encryptedpwd);
var test= new PasswordRepository();

//test.SavePassword(encryptedpwd);
string myEncryptedPWD= test.GetPassword();
//myEncryptedPWD.Dump();
}
...
{
    private const string GenericCredentials = "MattsEncryptedPassword";
    ...
    public void SavePassword(string password)
    {
        using (var cred = new Credential())
        {
			...
			cred.Username=User;
            cred.Target = GenericCredentials;
